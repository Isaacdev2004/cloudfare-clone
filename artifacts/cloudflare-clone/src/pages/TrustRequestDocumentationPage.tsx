        ...
        <div className="relative z-[1] mx-auto max-w-[640px] px-6">
          ...
          >
            ...
            <button
              ...
              className="inline-flex w-full min-h-[3rem] items-center justify-center rounded-lg bg-[#1E3A8A] px-6 py-3.5 font-sans text-[15px] font-semibold text-white transition-colors hover:bg-[#172E73] disabled:cursor-not-allowed disabled:opacity-80"
            >
